...
function ButtonGroupSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "bg-primary relative self-stretch data-[orientation=horizontal]:mx-px data-[orientation=horizontal]:w-auto data-[orientation=vertical]:my-px data-[orientation=vertical]:h-auto",
        className
      )}
      {...props}
    />
